...
namespace AlbumCollectionMastery.Migrations
{
    ...
    [Migration("20190311064929_ChangedModel")]
            ...
            modelBuilder.Entity("AlbumCollectionMastery.Models.Song", b =>
                {
                    ...
                    b.HasData(
                        ...
                        new { SongId = 5, AlbumId = 2, SongTitle = "Take Five" },
                        new { SongId = 6, AlbumId = 2, SongTitle = "Stream of Consciousness" },
                        new { SongId = 7, AlbumId = 3, SongTitle = "Dean Town" },
                        new { SongId = 8, AlbumId = 3, SongTitle = "Time Traveler" },
                        new { SongId = 9, AlbumId = 3, SongTitle = "It Gets Funkier IV" }
                    );
                });
